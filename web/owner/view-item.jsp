            ...
            <div class="row">
                ...
                <div class="col col-md-3 mt-3">
                    <div class="card text-capitalize">
                        ...
                        <div class="card-body">
                            <p><b>Item Description : </b><%=rs1.getString("itemDesc")%></p>
                            <p><b>Item Quantity : </b><%=rs1.getInt("itemQuantity")%></p>
                            <p><b>Item Price : </b>RM<%=rs1.getBigDecimal("itemPrice")%></p>
                            <div class="row">
                                <div class="col text-center">
                                    <a href="update-item.jsp?itemID=<%=rs1.getString("itemID")%>" class="btn btn-primary col-md-6">Update</a>
                                </div>
                                <div class="col text-center">
                                    <a href="../controllers/delete-item.jsp?itemID=<%= rs1.getString("itemID")%>" class="btn btn-danger col-md-6" onclick="return confirm('Confirm to delete this item?');">Delete</a>
                                </div>
                            </div>
                        </div>
                    </div>
