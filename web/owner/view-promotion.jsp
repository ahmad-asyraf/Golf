...
//    IF Login Session Expired Return back to login.html page
    ...
    String sql1 = "SELECT * FROM promotion";
...
<html>
    <head>
        <title>View Promotion - Admin</title>
        <meta charset="utf-8">
            ...
            <div class="row">
                ...
                <div class="col-12 col-md-3 mt-3">
                    <div class="card p-3 text-capitalize">
                        <p><b>Promotion ID: </b><%=rs1.getString("promoID")%></p>
                        <p><b>Promotion Value: </b><%=rs1.getString("promovalue")%></p>
                        <p><b>Promotion Start Date : </b><%=rs1.getString("startDate")%></p>
                        <p><b>Promotion End Date : </b><%=rs1.getString("endDate")%></p>

                        <div class="row">
                            <div class="col text-center">
                                <a href="update-promotion.jsp?promoID=<%=rs1.getString("promoID")%>" class="btn btn-primary col-md-6">Update</a>
                            </div>
                            <div class="col text-center">
                                <a href="../controllers/delete-promotion.jsp?promoID=<%= rs1.getString("promoID")%>" class="btn btn-danger col-md-6" onclick="return confirm('Confirm to delete this promotion?');">Delete</a>
                            </div>
                        </div>
                    </div>
                </div>
