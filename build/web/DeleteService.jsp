        ...
        <nav class="navbar navbar-expand-lg bg-light">
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        <li class="nav-item">
                            <a class="nav-link active" aria-current="page" href="ViewService.jsp">Back</a>
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col col-md-3 mt-3">
                    <div class="card p-3">
                        <form action="DeleteService1.jsp" method="POST">
                            <div class="text-center">
                                <img src="images/golf3.jpg" width="200px" height="200px">
                            </div>
                            <h1 class="text-center"> <%=rs.getString("serviceid")%></h1>
                            <p><b>Service ID:</b><%=rs.getString("serviceid")%></p>
                            <p><b>Service Name: </b><%=rs.getString("servicename")%></p>
                            <p><b>Service Price : </b><%=rs.getString("serviceprice")%></p>


                    <div class="col text-center">
                        <a href="DeleteService1.jsp?serviceid=<%= rs.getString("serviceid") %>" class="btn btn-primary col-md-6">Delete</a>
                    </div>
                        </form>
                    </div>
                    </div>
