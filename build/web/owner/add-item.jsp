                    ...
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a class="dropdown-item active" href="add-item.jsp">Add Items</a></li>
            ...
            <div class="col-md-12">
                <div class="profile-content">
                    <div class="form-popup bg-light p-5 mt-5 text-capitalize" id="myForm">
                        <form action="../controllers/add-item.jsp" method="post">
                            <div class="col-md-4 mx-auto">
                                <label class="form-label" for="fname">Enter Name of the Item:</label>
                                <input type="text" name="itemName" class="form-control" required>
                            </div>
                            <div class="col-md-4 mt-3 mx-auto">
                                <label class="form-label" for="fname">Enter Description of the Item:</label>
                                <input type="text" name="itemDesc" class="form-control" required>
                            </div>
                            <div class="col-md-4 mt-3 mx-auto">
                                <label class="form-label" for="fname">Enter Quantity of the Item:</label>
                                <input type="text" name="itemQuantity" class="form-control" required>
                            </div>
                            <div class="col-md-4 mt-3 mx-auto">
                                <label class="form-label" for="fname">Enter Price of the Item:</label>
                            ...
                            <div class="col-md-4 mt-3 mx-auto">
                                <button type='back' class="btn btn-primary col-md-12" a href="homepage.jsp">Back</button>
                            </div>
                        </form>
                    </div>
                </div>
