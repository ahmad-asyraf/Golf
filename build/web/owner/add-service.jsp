                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a class="dropdown-item active" href="add-service.jsp">Add Services</a></li>
            ...
            <div class="col-md-12">
                <div class="profile-content">
                    <div class="form-popup bg-light p-5 mt-5 text-capitalize" id="myForm">
                        <form action="../controllers/add-service.jsp" method="post">
                            <div class="col-md-4 mx-auto">
                                <label class="form-label" for="fname">Enter Service ID:</label>
                                <input type="text" name="serviceid" class="form-control" placeholder="Format Servxx" required>
                            </div>
                            <div class="col-md-4 mt-3 mx-auto">
                                <label class="form-label" for="fname">Enter Name of the Service:</label>
                                <input type="text" name="servicename" class="form-control" required>
                            </div>
                            <div class="col-md-4 mt-3 mx-auto">
                                <label class="form-label" for="fname">Enter Price of the service:</label>
                                <input type="text" name="serviceprice" class="form-control" required>
                            </div>
                            <div class="col-md-4 mt-3 mx-auto">
