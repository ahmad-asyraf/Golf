            ...
            <div class="col-md-12">
                <div class="profile-content">
                    <div class="form-popup bg-light p-5 mt-5 text-capitalize">
                        <form action="../controllers/update-service.jsp" method="POST" onsubmit="return confirm('Confirm to update?');">
                            <input type="hidden" name="serviceid" value="<%= rs1.getString("serviceid")%>">
                            <div class="col-md-4 mx-auto">
                                <label class="form-label">Service Name:</label>
                                <input type="text" name="servicename" class="form-control" value="<%= rs1.getString("servicename")%>">
                            </div>
                            <div class="col-md-4 mt-3 mx-auto">
                                <label class="form-label">Service Price:</label>
                                <input type="text" name="serviceprice" class="form-control" value="<%= rs1.getString("serviceprice")%>">
                            </div>
