                    ...
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a class="dropdown-item active" href="view-item.jsp">View Items</a></li>
                            </ul>
                        </li>
                        <li class="nav-item dropdown">
            ...
            <div class="col-md-12">
                <div class="profile-content">
                    <div class="form-popup bg-light p-5 mt-5 text-capitalize">
                        <form action="../controllers/update-item.jsp" method="POST" onsubmit="return confirm('Confirm to update?')">
                            <input type="hidden" name="itemID" value="<%= rs1.getString("itemID")%>">
                            <div class="col-md-4 mx-auto">
                                <label class="form-label">Item Name:</label>
                                <input class="form-control" type="text" name="itemName" value="<%= rs1.getString("itemName")%>">
                            </div>
                            <div class="col-md-4 mt-3 mx-auto">
                                <label class="form-label">Item Description:</label>
                                <input class="form-control" type="text" name="itemDesc" value="<%= rs1.getString("itemDesc")%>">
                            </div>
                            <div class="col-md-4 mt-3 mx-auto">
                                <label class="form-label">Item Quantity:</label>
                                <input class="form-control" type="text" name="itemQuantity" value="<%= rs1.getString("itemQuantity")%>">
                            </div>
                            <div class="col-md-4 mt-3 mx-auto">
                                <label class="form-label">Item Price:</label>
                                <input class="form-control" type="text" name="itemPrice" value="<%= rs1.getString("itemPrice")%>">
                            </div>
